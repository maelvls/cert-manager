...
func ListCertificateRequestsMatchingPredicates(listCRs func(labels.Selector) ([]*cmapi.CertificateRequest, error), selector labels.Selector, predicates ...predicate.Func) ([]*cmapi.CertificateRequest, error) {
	reqs, err := listCRs(selector)
	if err != nil {
		return nil, err
	}
